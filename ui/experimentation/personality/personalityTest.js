// JavaScript Version - No type safety
// All values are dynamic, bugs caught at runtime
...
export function calculateScore(response, direction) {
...
export function calculatePersonalityType(scores) {
  let type = "";
...
export function calculatePercentage(score, numQuestions) {
...
export function getPersonalityDescription(personalityType) {
  const baseType = personalityType.split("-")[0];
